'use client';
// src/app/(admin)/payments/customer/page.tsx
...
export default function CustomerPaymentsPage() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    try {
      const res = await customerPaymentService.list({ page, limit: LIMIT });
  ...
  const handleSave = async () => {
    ...
    if (!form.invoice_id.trim())  { toast.error('Invoice ID is required'); return; }
              ...
              {loading ? (
                ...
                <tr><td colSpan={6}>
                  <div className="empty-state py-12">
                    ...
                    <p className="empty-state-desc">Record a customer payment to track collections.</p>
